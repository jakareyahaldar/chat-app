export default function EmojiBox({setEmoji,isOpen}){
  ...
  return(
    <div className="md:w-[300px] w-fit max-h-[300px] overflow-y-scroll bg-amber-100 rounded-xl grid grid-cols-6 gap-3 p-3 m-auto">
      {
        emojiCode.map((code)=>{
          return <div 
